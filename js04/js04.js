...
const apellidosCh26 = new Array("Montellano","Torres", "Vázquez");
...
//---------------Ejercicio--------------
// Iterar y mostras a las personas en cohorte y detener
// cuando se encuentre a Maria, es decir, dejar de iterar
...
/*
    ...
    con la próxima iteración (o en label que se indique).
*/
...
console.log("El valor de a es: "+ (ex1()));
...
Queda muy bien para hacer un menú y un switch
*/
/*
let iteration = 0;
do {
